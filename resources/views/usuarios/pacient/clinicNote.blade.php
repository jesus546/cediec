            ...
            <form action="{{ route('clinic_note.store', $usuario) }}" method="POST">
              @csrf
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="laboratorio" name="laboratorio" rows="3" value="{{ old('laboratorio') }}"> </textarea>
                </div>
                <div class="form-group">
                  <label for="plan_de_manejo"  ><h6><strong >Plan De Manejo:</strong></h6></label>
                  <textarea class="form-control" id="plan_de_manejo" name="plan_de_manejo" rows="3" value="{{ old('plan_de_manejo') }}"> </textarea>
                </div>
                <div class="form-group">
